...
export default function PolicyForm({ onSubmit, isLoading }: PolicyFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="border-4 border-black p-6">
      <h2 className="text-2xl font-black uppercase mb-6">Design reform</h2>
      ...
      <div className="space-y-6">
        <div>
          ...
          <div className="flex items-center space-x-2">
            ...
            <input
              ...
              className="flex-1 px-3 py-2 border-2 border-black font-mono focus:outline-none focus:ring-0"
              min="0"
              max="500000"
              step="1000"
            />
        ...
        <div>
          ...
          <div className="space-y-3">
            <label className="flex items-start">
              ...
              />
              <div>
                <div className="font-bold">No taper</div>
            ...
            <label className="flex items-start">
              ...
              />
              <div>
                <div className="font-bold">Moderate taper</div>
            ...
            <label className="flex items-start">
              ...
              />
              <div>
                <div className="font-bold">Aggressive taper</div>
                <div className="text-xs">
            ...
            <label className="flex items-start">
              ...
              />
              <div>
                <div className="font-bold">Custom taper</div>
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full py-3 px-4 bg-black text-white font-bold uppercase hover:bg-white hover:text-black hover:border-2 hover:border-black focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed transition-all"
        >
